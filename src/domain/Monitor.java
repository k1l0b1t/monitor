...
public class Monitor
{
	 ...
	 * @throws UnknownHostException
	 */
	public Monitor(String name, String ip, boolean isOnline)
		throws UnknownHostException
	{
		setName(name);
		setIp(ip);
	 ...
	 * Setter for the ip
	 * 
	 * @param ip String containing the IP of the monitor. Either ipv4, ipv6 or
	 *           FQDN
	 * @throws UnknownHostException
	 */
	...
	{
		return String.format("Monitor %s (%s): %s%n", this.name,
			this.ip.toString(), this.isOnline);
	}
